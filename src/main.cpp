...
unsigned int nTargetSpacing = 40; // 40 seconds
...
int nCoinbaseMaturity = 80; // 100 blocks for coins to mature
...
const string strMessageMagic = "Ukra Signed Message:\n";
...
static const int64_t nTargetTimespan = 12 * 60;  // 12 mins
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ukra", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        nStakeMinAge = 2 * 60; // test net min age is 2 minutes
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.co.uk/news/world-us-canada-41541002";  //Storm Nate weakens but Alabama flood threat remains
        CTransaction txNew;
        txNew.nTime = 1507482433;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 4861235 << CBigNum(42) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x995cf052899e167f7f29aeb26222ab75e49a7a158d8632902117059b7c0bb31c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x04, 0xd3, 0xe1, 0x08 };
